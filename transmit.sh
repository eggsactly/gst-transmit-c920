...
gst-launch-1.0 -v \
	...
	alsasrc device=hw:1 ! audio/x-raw, rate=32000, channels=2, format=S16LE, encoding-name=L24 ! audioconvert ! rtpL24pay ! application/x-rtp, payload=96 ! udpsink host=224.1.1.1 port=5002 auto-multicast=true 
